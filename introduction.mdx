...
Commit+ is being built toward a more direct, visual Git workflow. Some of the broader ideas in the README and feature pages are product direction rather than a promise that every action is already shipped. Pages in this docs site call out planned behavior when a workflow is still on the roadmap.
